#!/bin/sh
set -e
# Code generated by godownloader on 2022-11-15T13:25:43Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for cloudentity/oauth2c

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/fuji97/oauth2c/releases
